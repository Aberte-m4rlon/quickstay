        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ url('/') }}">
                        <span class="text-xl font-bold text-blue-600">QuickStay</span>
                    </a>
                </div>
                ...
                @auth
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        ...
                        @if(auth()->user()->role === 'renter')
                            <x-nav-link :href="route('renter.dashboard')" :active="request()->routeIs('renter.*')">
                                {{ __('Renter Dashboard') }}
                            </x-nav-link>
                        @endif
                    </div>
                ...
                @else
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <a href="{{ route('register') }}"
                            class="text-sm text-gray-600 hover:text-gray-800">Register</a>
                    </div>
                @endauth
            </div>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        @auth
            <div class="pt-2 pb-3 space-y-1">
                ...
                @if(auth()->user()->role === 'renter')
                    <x-responsive-nav-link :href="route('renter.dashboard')"
                        :active="request()->routeIs('renter.*')">
                        {{ __('Renter Dashboard') }}
                    </x-responsive-nav-link>
                @endif
            </div>
